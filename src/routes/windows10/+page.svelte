...
<style>
	...
	.app-tile:hover { background: rgba(255, 255, 255, 0.25); }
	.app-tile-name { font-size: 12px; color: #fff; text-align: center; font-weight: 500; line-height: 1.3; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.5); }
</style>
